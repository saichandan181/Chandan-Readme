...
<a href="mailto:sanda.rsc@icloud.com"><img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=maildotru&logoColor=white" alt="Email"/></a>
...
<a href="https://github.com/saichandan181?tab=stars"><img src="https://img.shields.io/badge/Stars_Given-264-36BCF7?style=for-the-badge&labelColor=0f2027" alt="Stars"/></a>
...
portfolio: https://saichandan.vercel.app
...
![Claude](https://img.shields.io/badge/Claude_Agent_SDK-D97757?style=flat-square&logo=anthropic&logoColor=white)
...
![EAS Build](https://img.shields.io/badge/EAS_Build-4630EB?style=flat-square&logo=expo&logoColor=white)
...
|---|---|---|
| **[polyagent](https://github.com/saichandan181/polyagent)** | Multi-tenant trading agent for Polymarket — isolated per-tenant strategy execution | `TypeScript` |
| **[Gemini-Vision-pro](https://github.com/saichandan181/Gemini-Vision-pro)** | Generative AI app built on Gemini's multimodal vision capabilities | `Python` `Gemini` |
| **[testvibe-pos](https://github.com/saichandan181/testvibe-pos)** | AI-assisted test generation & execution surface for POS workflows | `TypeScript` |
| **[backendapi-pos](https://github.com/saichandan181/backendapi-pos)** | Python API layer powering the POS platform | `Python` `FastAPI` |
| **[aiexpensetracker](https://github.com/saichandan181/aiexpensetracker)** | Expense tracking with LLM-based categorization & insights | `HTML` `JS` |
| **[onlyus](https://github.com/saichandan181/onlyus)** | Full-stack side project | `TypeScript` |
...
- Fine-tuning and retrieval strategies for domain-specific LLMs
...
- Python, JavaScript/TypeScript, Java, HTML/CSS — and where each actually earns its keep
- Building generative AI apps on top of multimodal models
...
<a href="https://www.buymeacoffee.com/saichandan"><img src="https://img.shields.io/badge/Buy_Me_A_Coffee-FFDD00?style=for-the-badge&logo=buymeacoffee&logoColor=black" alt="Buy Me A Coffee"/></a>
